...
class MainWindow(QtWidgets.QWidget):
    ...
    def _build_scene(self):
        ...
        # Celestial equator (fixed in equatorial frame)
    ...
    def update_scene(self):
        ...
        # ============================================
        # Celestial equator is the XY plane in equatorial coordinates (no transformation)
        eq = make_ring(self.radius, 600, "xy")
        self.eq_item.setData(pos=eq)
        
        # Milky Way is already in equatorial XYZ (no transformation)
        self.mw_item.setData(pos=self.mw_pts_eq, color=self.mw_cols)
        
        # Sun in equatorial coordinates (no transformation for display)
        ...
        # For alt/az calculation, transform Sun to local ENU
        ...
        # Galactic center in equatorial coordinates (no transformation for display)
        gc_eq = gc_unit_eq()
